...
Další funkce umožňují zobrazit různé meteorologické prvky z kraje v jednom grafu.
...
Additional features allow users to visualize various meteorological elements from a region within a single graph.
